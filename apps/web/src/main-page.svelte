...
<Layout>
  {#snippet append()}
    ...
    <a
      ...
      target="_blank"
    >
      <svg aria-hidden="true" viewBox="0 0 24 24" version="1.1" class="w-8 h-8 fill-base-content">
